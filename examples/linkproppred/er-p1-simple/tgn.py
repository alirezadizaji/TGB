...
# data loading
with open("../tse/data/er-p1-simple/data.npz", "r") as f:
    src = f["src"]
    dst = f["dst"]
    t = f["t"]
    edge_feat = f["edge_feat"]
    node_feat = f["node_feat"]
...
for run_idx in range(NUM_RUNS):
    ...
    neg_sampler.load_eval_set("../tse/data/ER-P1-simple.val_ns.pkl", split_mode="val")
    ...
    neg_sampler.load_eval_set("../tse/data/ER-P1-simple.test_ns.pkl", split_mode="test")
